...
ax[0].plot(freq, np.abs(bare_spectrum), color=cm[1], label='Original')
ax[0].plot(freq, np.abs(bare_spectrum2), color=cm[4], label='Fixed Periodicity')
...
ax[1].plot(freq, np.abs(np.abs(bare_spectrum) - np.abs(bare_spectrum2)), color=cm[7])
